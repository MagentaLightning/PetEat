...
public class ChangeEmailActivity extends AppCompatActivity {
    ...
    public void changeEmail(){
        ...
        final String newemailtext = edit_text_new_email.getText().toString().trim();
                        ...
                        user.updateEmail(newemailtext)
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        {
                                            Toast.makeText(ChangeEmailActivity.this, R.string.error_snackbar_profile_failed,
                                                    Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    } else {
                        Toast.makeText(ChangeEmailActivity.this,R.string.error_auth_failed_,
                                Toast.LENGTH_SHORT).show();
                    }
                }
                });
